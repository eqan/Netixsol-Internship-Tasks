...
/*
    As you know anyone can send a message using a smart contract. Did you know you can
    sign the messages using your private key? Even if you didn’t, well now you know!
    For this challenge, you have to write a smart contract to sign a message. Then to verify the
    signature we will need another function as well!
    Hint: You will have to use the Remix console and you will have to connect your MetaMask
    account as well.
*/
